                ...
                <div class="grid grid-cols-2 gap-3">
                    ...
                    <div id="buy-now-modal" class="fixed inset-0 bg-black bg-opacity-50 z-50 hidden flex items-center justify-center">
                        <div class="bg-white rounded-lg p-8 max-w-lg w-full max-h-[90vh] overflow-y-auto">
                            ...
                            <form action="{{ route('checkout.quick') }}" method="POST" id="buy-now-form">
                                @csrf
                                <input type="hidden" name="product_id" value="{{ $product->id }}">
                                <input type="hidden" name="quantity" value="1" class="quantity-input">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="grid grid-cols-3 gap-3">
                                        <div>
                                            <input type="radio" id="payment_cod" name="payment_method" value="cod" checked class="hidden peer">
                                        ...
                                        <div>
                                            <input type="radio" id="payment_card" name="payment_method" value="card" class="hidden peer">
                                        ...
                                        <div>
                                            <input type="radio" id="payment_bank" name="payment_method" value="gcash" class="hidden peer">
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        // Product data
        const productContainer = document.querySelector('.bg-white.rounded-xl');
        ...
        if (buyNowButton && buyNowModal && closeModalButton) {
            buyNowButton.addEventListener('click', function() {
                ...
                buyNowForm.querySelector('input[name="product_id"]').value = productId;
